...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  header{background:var(--yellow); border-bottom:4px solid var(--ink); padding:14px 16px;}
  header a{color:var(--ink); font-weight:900; text-decoration:none; font-size:18px;}
...
<body>
  <header><a href="../../index.html">🧱 你想像的樂高倉庫</a></header>
  <main>
